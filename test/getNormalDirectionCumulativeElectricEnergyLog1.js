...
(async () => {
    ...
    //const res = await wisunrb.getNormalDirectionCumulativeElectricEnergyLog1();
    //const res = await wisunrb.getNormalDirectionCumulativeElectricEnergyLog1({ day: 0 });
    //const res = await wisunrb.getNormalDirectionCumulativeElectricEnergyLog1({ day: 40 });
    const res = await wisunrb.getNormalDirectionCumulativeElectricEnergyLog1({ day: 45 });
    console.log(JSON.stringify(res, null, '  '));

    /*
    console.log('- 積算電力量計測値履歴1 (正方向計測値): ' + res.day + ' 日前');
